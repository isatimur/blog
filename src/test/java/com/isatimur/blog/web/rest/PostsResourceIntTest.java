...
public class PostsResourceIntTest {
    ...
    public void initTest() {
        ...
        posts.setContentContentType(DEFAULT_CONTENT_CONTENT_TYPE);
    ...
    public void createPosts() throws Exception {
        ...
        assertThat(testPosts.getContentContentType()).isEqualTo(DEFAULT_CONTENT_CONTENT_TYPE);
    ...
    public void updatePosts() throws Exception {
        ...
        updatedPosts.setContentContentType(UPDATED_CONTENT_CONTENT_TYPE);
        ...
        assertThat(testPosts.getContentContentType()).isEqualTo(UPDATED_CONTENT_CONTENT_TYPE);
